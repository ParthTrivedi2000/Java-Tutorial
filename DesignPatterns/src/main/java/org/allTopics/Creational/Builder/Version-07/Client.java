/*
So to make Student Constructor cleaner and easily readable, we can create seperate method
...
And consequense is attributes are not validated, and object is available directly to the client without
