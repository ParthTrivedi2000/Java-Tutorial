...
Hence I can perform validation on few of them based on the the values set, and if those are upto the mark then
...
class Client{
    public static void main(String[] args){
        ...
        Student = new Student(mp);
    }
}

/*
Now issue with this approach is:-
1) No one will prevent me to write worng attribute name as key. for examp name --> neam. so just mean to say that
