...
/*
 ...
 But problem is, requirement is saying, it is not fixed like which attribute user/client wants
 ...
 require arguments (but here required argument is not fixed so need to create for each combination)).
 (Go to Student.java)
