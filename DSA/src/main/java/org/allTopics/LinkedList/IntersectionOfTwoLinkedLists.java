...
class IntersectionOfTwoLinkedLists{
    public ListNode getIntersectionNode(ListNode headA, ListNode headB) {
        ...
        // then iterate on them to find the intersection by using Map/Set (means previously in hashing class we
        // already did question of intersection of arrays).
        // then final ans again we can converted into the Linked List.
...
// Please go through all the approaches :- https://takeuforward.org/data-structure/find-intersection-of-two-linked-lists/
