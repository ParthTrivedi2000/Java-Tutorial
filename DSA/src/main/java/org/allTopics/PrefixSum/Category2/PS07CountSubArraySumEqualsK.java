...
public class PS07CountSubArraySumEqualsK {
    ...
    // Approach - 2:- Optimised Bruteforce Approach :- Using 2 loops :-
    // TC:- O(N^2), SC:- O(1)
    /*
    // Function to find count of subarrays with sum equal to k
    public int subarraySum(int[] arr, int k) {
    ...
    // Approach - 3:- Efficient Approach :- Using Carry Forward + Hashing :-
    // TC:- O(N), SC:- O(N)
